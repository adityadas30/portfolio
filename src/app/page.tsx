...
function AnimatedHeroName() {
  ...
  if (!isDesktop) {
    return (
      <h1 className="text-5xl sm:text-6xl md:text-[7rem] font-bold tracking-tighter leading-none mb-4 font-hero text-white whitespace-pre">
        Aditya Das
      </h1>
    );
  }
  ...
  return (
    <div ref={containerRef} className="text-5xl sm:text-6xl md:text-[7rem] font-bold tracking-tighter leading-none mb-4 h-20 md:h-[8rem] flex items-center relative overflow-hidden text-white">
    ...
    <main className="relative min-h-screen break-words">
      ...
      <div className="flex flex-col w-full">
            ...
            <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-12 gap-12">
              ...
              <div className="md:col-span-9 flex flex-col gap-16">
                ...
                <div className="flex gap-6 group">
                  <div className="w-12 h-12 flex-shrink-0 bg-white border border-gray-200 rounded-sm relative mt-1 flex items-center justify-center overflow-hidden overflow-visible">
        ...
        <section id="connect" className="py-40 px-6 flex flex-col items-center justify-center text-center bg-[#f4f3ef]">
          <Reveal>
            <h2 className="text-3xl md:text-5xl font-bold tracking-tighter text-black mb-12">Get in touch.</h2>
